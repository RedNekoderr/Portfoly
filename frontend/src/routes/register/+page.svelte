  ...
  <div class={`${viewportWidth > 600 ? "w-50" : ""} container`} id="main">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            <h2 class="text-center text title-unfree mt-5">Sign up</h2>
            <form class="px-3" on:submit|preventDefault={register}>
              <div class="mt-5">
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="mt-2 mb-5 text-center">
              <a href="/login" class="text button subtle">Sign in</a>
            </div>
          </div>
        </div>
      </div>
